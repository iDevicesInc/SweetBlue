...
public class BleServer_ServiceAddWrapper
		...
		com.idevicesinc.sweetblue.BleServer.ServiceAddListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Idevices.Sweetblue.BleServer/ServiceAddWrapper, SweetBlue, Version=2.6.10.0, Culture=neutral, PublicKeyToken=null", BleServer_ServiceAddWrapper.class, __md_methods);
	}


	public BleServer_ServiceAddWrapper () throws java.lang.Throwable
	{
		super ();
		if (getClass () == BleServer_ServiceAddWrapper.class)
			mono.android.TypeManager.Activate ("Idevices.Sweetblue.BleServer/ServiceAddWrapper, SweetBlue, Version=2.6.10.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
