...
public abstract class ServerOutgoingListener
		...
		com.idevicesinc.sweetblue.BleServer.ExchangeListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Idevices.Sweetblue.ServerOutgoingListener, SweetBlue, Version=2.6.10.0, Culture=neutral, PublicKeyToken=null", ServerOutgoingListener.class, __md_methods);
	}


	public ServerOutgoingListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ServerOutgoingListener.class)
			mono.android.TypeManager.Activate ("Idevices.Sweetblue.ServerOutgoingListener, SweetBlue, Version=2.6.10.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
