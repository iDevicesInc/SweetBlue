		...
		com.idevicesinc.sweetblue.BleManager.DiscoveryListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Idevices.Sweetblue.DiscoveryListener, SweetBlue, Version=2.6.10.0, Culture=neutral, PublicKeyToken=null", DiscoveryListener.class, __md_methods);
	}


	public DiscoveryListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == DiscoveryListener.class)
			mono.android.TypeManager.Activate ("Idevices.Sweetblue.DiscoveryListener, SweetBlue, Version=2.6.10.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
