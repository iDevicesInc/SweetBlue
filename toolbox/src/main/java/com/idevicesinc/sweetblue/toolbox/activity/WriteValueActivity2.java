...
public class WriteValueActivity2 extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mLoadValueSpinner = null;//find(R.id.loadValueSpinner);
    ...
    private void writeValue()
    {
        ...
        try
        {
            ...
            final Dialog d = ProgressDialog.show(WriteValueActivity2.this, getString(R.string.write_value_writing_dialog_title), getString(R.string.write_value_writing_dialog_message));
