...
class P_WakeLockManager
{
	...
	public P_WakeLockManager(BleManager mngr, boolean enabled)
	{
		...
		if( enabled )
		{
			if( !Utils.hasPermission(mngr.getContext(), permission.WAKE_LOCK) )
			{
			...
			PowerManager powerMngr = (PowerManager) m_mngr.getContext().getSystemService(Context.POWER_SERVICE);
