...
public class BleAdvertisingSettings {
    ...
    /**
     * Type-safe parallel of static final int members of {@link android.bluetooth.le.AdvertiseSettings}.
     * Provide an instance to {@link BleServer#startAdvertising(BleAdvertisingPacket, BleAdvertisingSettings.BleAdvertisingMode, BleAdvertisingSettings.BleTransmissionPower)},
     * {@link BleServer#startAdvertising(BleAdvertisingPacket, com.idevicesinc.sweetblue.BleAdvertisingMode, BleTransmissionPower, Interval)}, or
     * {@link BleServer#startAdvertising(BleAdvertisingPacket, com.idevicesinc.sweetblue.BleAdvertisingMode, BleTransmissionPower, Interval, BleServer.AdvertisingListener)}
     * This is only applicable for Android >= 5.0 OS levels.
     */
