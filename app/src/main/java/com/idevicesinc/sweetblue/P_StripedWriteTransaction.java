...
final class P_StripedWriteTransaction extends BleTransaction
{
    ...
    P_StripedWriteTransaction(FutureData data, BluetoothGattCharacteristic characteristic, boolean requiresBonding, DescriptorFilter filter, ReadWriteListener listener)
    {
        m_data = data;
