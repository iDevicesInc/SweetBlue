...
public class ScanTest extends BaseBleUnitTest
{
    ...
    public void scanClassicOneTimeTest() throws Exception
    {
        ...
        m_mgr.setListener_State(e ->
        {
            ...
            {
                assertFalse("Scan task is in the queue, when it should not be!", m_mgr.getTaskManager().isInQueue(P_Task_Scan.class, m_mgr) || m_mgr.getTaskManager().isCurrent(P_Task_Scan.class, m_mgr));
                succeed();
            }
        });
    ...
    public void highPriorityScanTest() throws Exception
    {
        ...
        m_mgr.setListener_State(e ->
        {
            if (e.didEnter(BleManagerState.SCANNING))
            {
                P_TaskManager queue = m_mgr.getTaskManager();
